...
void Init_mpu6050(void)
{
  ...
  mpu.setXAccelOffset(-5778);
  mpu.setYAccelOffset(-17);
  mpu.setZAccelOffset(5254);
...
unsigned char Gravity_Check(void)
{
    if(X_Data > 20)         return  1;
    else  if(X_Data < -20)  return  1;
    
    else  if(Y_Data > 20)   return  2;
    else  if(Y_Data < -20)  return  2;
